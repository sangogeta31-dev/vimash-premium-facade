...
const attaRaw: Raw[] = [
  {
    ...
    dimension: 'H-46", W-20", L-56"',
    mainMotor: "5 HP",
    cycloneMotor: "0.5 & 0.5 HP",
    voltage: "440-V",
    bigChamber: '10"x5"',
    smallChamber: "8\"x4'",
    weight: "185 KG APPROX",
    airLock: "110KG APPROX",
  },
  {
    hp: "7.5",
    ...
    power: "5 KWH",
    chamber: "Double",
    dimension: 'H-47", W-24", L-59"',
    mainMotor: "7.5 HP",
    cycloneMotor: "0.5 HP & 1 HP",
    voltage: "440 V\u00a0",
    bigChamber: '12"x6"',
    smallChamber: '8"x4"',
    weight: "198 KG APPROX",
    airLock: "110 KG APPROX",
  },
  {
    hp: "10",
  ...
  },
  {
    ...
    power: "10 KWH",
    chamber: "Double",
    dimension: 'H-54", W-31", L-69"',
    mainMotor: "15 HP",
    cycloneMotor: "0.5 HP & 2 HP",
    voltage: "440 V\u00a0",
    bigChamber: '16"x8"',
    smallChamber: '10"x4"',
  ...
  },
  {
    ...
    power: "15 KWH",
    chamber: "Double",
    dimension: 'H-58", W-34", L-72"',
    mainMotor: "20 HP",
    cycloneMotor: "0.5 HP & 2 HP",
    voltage: "440 V · 3 Phase",
    bigChamber: '18"x9"',
    smallChamber: '11"x5"',
    weight: "270 KG APPROX",
    airLock: "110 KG APPROX",
  },
];
...
const masalaRaw: Raw[] = [
  {
    ...
    power: "4 KWH",
    chamber: "Double Chamber",
    dimension: "L 1306 × W 600 × H 1170 mm",
    mainMotor: "5 HP, 1440 RPM",
    cycloneMotor: "0.5 HP & 0.5 HP",
    voltage: "440 V · 3 Phase",
  },
  {
    hp: "7.5",
    ...
    power: "5 KWH",
    chamber: "Double Chamber",
    dimension: "L 1448 × W 700 × H 1290 mm",
    mainMotor: "7.5 HP, 1440 RPM",
    cycloneMotor: "0.5 HP & 1 HP",
    voltage: "440 V · 3 Phase",
  },
  {
    ...
    power: "10 KWH",
    chamber: "Double Chamber",
    dimension: "L 1530 × W 800 × H 1355 mm",
    mainMotor: "10 HP, 1440 RPM",
    cycloneMotor: "0.5 HP & 1 HP",
    voltage: "440 V · 3 Phase",
  },
  {
    ...
    power: "15 KWH",
    chamber: "Double Chamber",
    dimension: "L 1600 × W 860 × H 1430 mm",
    mainMotor: "15 HP, 1440 RPM",
    cycloneMotor: "0.5 HP & 2 HP",
    voltage: "440 V · 3 Phase",
  },
  {
    ...
    power: "15 KWH",
    chamber: "Double Chamber",
    dimension: "L 1670 × W 960 × H 1520 mm",
    mainMotor: "20 HP, 1440 RPM",
    cycloneMotor: "0.5 HP & 2 HP",
    voltage: "440 V · 3 Phase",
  },
];
...
function build(raw: Raw, category: Category): Product {
  ...
  if (isAtta) {
    ...
    if (raw.hp === "5")
      ...
      name = "Masala Grinder Machine 15HP Mirchi Grinding machine Haldi Grinder\u00a0";
    else if (raw.hp === "20")
      name = "20HP Masala Grinder Machine Haldi Grinder Mirchi Grinder\u00a0\u00a0";
  ...
  return {
    ...
    price: isAtta
      ? (attaPriceMap[raw.hp] ?? "On request")
      : (masalaPriceMap[raw.hp] ?? "On request"),
