...
export const Route = createFileRoute("/about")({
  head: () => ({
    ...pageMeta({
      ...
      description:
        "Vimash Manufacturing India Private Limited makes commercial atta chakki pulverizers and masala grinding machines in Ahmedabad. Own factory, tested machines, PAN India delivery and support.",
      path: "/about",
  ...
  return (
    <>
      <PageHero
        ...
        description="Vimash Manufacturing India Private Limited is based in Ahmedabad, India. We make commercial atta and masala Chakki for daily production."
      />
